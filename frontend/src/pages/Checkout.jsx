...
            className="w-full sm:w-auto flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-semibold transition-colors duration-200 **bg-gray-950 text-gray-50 hover:bg-gray-800**"
          >
            Continue Shopping
          </button>
        </div>
...
  return (
    <div className="mt-20 pt-20 min-h-screen **bg-gray-50** py-12 px-4 sm:px-6 lg:px-8">
...
                  <input
                    className="rounded-md border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:gray-800 focus:border-transparent"
                    required
...
                <input
                  type="tel"
                  className="w-full rounded-md border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:gray-800 focus:border-transparent"
                  required
...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-semibold transition-colors duration-200 bg-gray-600 text-gray-50 hover:bg-gray-800** disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {processing || loading ? (
                <>
